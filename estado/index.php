...
require_once '../class/populacao.php';
// Importação da class Educacao
require_once '../class/educacao.php';
// Importação da class Economia
require_once '../class/economia.php';
// Importacao da class Territorio
require_once '../class/territorio.php';
$estado = $_GET["estado"];
// Headers necessarios
...
if(isset($_GET["estado"])){
    ...
    if($resultado){ // verifica se o resultado nao esta vazio
        ...
        // ============ POPULACAO ============
        $pop = new Populacao();
        $populacao = $pop->getArrayPopulacao($resultado); 
        // ============ FIM POPULACAO ============

        // ============ EDUCACAO ============
        $edu = new Educacao();
        $educacao = $edu->getArrayEducacao($resultado);
        // ============ FIM EDUCACAO ============

        // ============ ECONOMIA ============
        $eco = new Economia();
        $economia = $eco->getArrayEconomia($resultado);
        // ============ FIM ECONOMIA ============

        // ============ TERRITORIO ============
        $ter = new Territorio();
        $territorio = $ter->getArrayTerritorio($resultado);
        // ============ FIM TERRITORIO ============
